...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            <livewire:cloth.show-bill />
            <!-- start page title -->
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">د جامو بیلونه</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                {{-- <li class="breadcrumb-item"><a href="javascript: void(0);">Tables</a></li> --}}
                                <li class="breadcrumb-item active">د جامو بیلونه</li>
                            </ol>
                        </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="row m-0 p-0" id="invoiceModal">
                                            <div class="col-lg-12 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="position-absolute d-flex flex-col-reverse"
                                                        ...
                                                        <form id="formBillAdd" wire:submit='create'>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4 col-sm-4 col-4">
                                                                    <div class="d-flex align-items-baseline ">
                                                                        ...
                                                                        <input {{$customerID == "" ? "disabled" : ""}} type="number" step="any"
                                                                ...
                                                                <div class="col-md-5 col-sm-5 col-5 ">
                                                                    <div class="d-flex align-items-baseline ">
                                                                        <label class="form-label" style="width:100px"
                                                                            for="">پټی</label>
                                                                        <select required {{$customerID == "" ? "disabled" : ""}} name=""
                                                                            wire:model='stripStyle_id'
                                                                            class="w-100  border border-light "
                                                                            id="">
                                                                            <option value=""></option>
                                                                            @foreach ($stripStyles as $staff)
                                                                                <option
                                                                                    {{ $stripStyle_id == $staff->id ? 'selected' : '' }}
                                                                                    value="{{ $staff->id }}">
                                                                                    {{ $staff->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="d-flex align-items-baseline ">
                                                                        ...
                                                                        <select required {{$customerID == "" ? "disabled" : ""}} name=""
                                                                            ...
                                                                            id="">
                                                                            <option value=""></option>
                                                                            @foreach ($neckStyles as $staff)
                                                                                <option  {{ $neckStyle_id == $staff->id ? 'selected' : '' }} value="{{ $staff->id }}">
                                                                                    {{ $staff->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                        @error('neckStyle_id')
                                                                    ...
                                                                    <div class="d-flex align-items-baseline ">
                                                                        ...
                                                                        <select required {{$customerID == "" ? "disabled" : ""}} name=""
                                                                            wire:model='sidePocketStyle_id'
                                                                            class="w-100  border border-light "
                                                                            id="">
                                                                            <option value=""></option>
                                                                            @foreach ($sidePocketStyles as $staff)
                                                                                <option  {{ $sidePocketStyle_id == $staff->id ? 'selected' : '' }} value="{{ $staff->id }}">
                                                                                    {{ $staff->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="d-flex align-items-baseline ">
                                                                        ...
                                                                        <select required {{$customerID == "" ? "disabled" : ""}} name=""
                                                                            wire:model='frontPocketStyle_id'
                                                                            class="w-100  border border-light "
                                                                            id="">
                                                                            <option value=""></option>
                                                                            @foreach ($frontPocketStyles as $staff)
                                                                                <option  {{ $frontPocketStyle_id == $staff->id ? 'selected' : '' }} value="{{ $staff->id }}">
                                                                                    {{ $staff->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="d-flex align-items-baseline ">
                                                                        ...
                                                                        <select required {{$customerID == "" ? "disabled" : ""}} name=""
                                                                            wire:model='salayeeStyle_id'
                                                                            class="w-100  border border-light"
                                                                            id="">
                                                                            <option value=""></option>
                                                                            @foreach ($salayeeStyles as $staff)
                                                                                <option {{ $salayeeStyle_id == $staff->id ? 'selected' : '' }}  value="{{ $staff->id }}">
                                                                                    {{ $staff->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="d-flex align-items-baseline ">
                                                                        ...
                                                                        <select required {{$customerID == "" ? "disabled" : ""}} name=""
                                                                            wire:model='buttonStyle_id'
                                                                            class="w-100  border border-light"
                                                                            id="">
                                                                            <option value=""></option>
                                                                            @foreach ($buttonStyles as $staff)
                                                                                <option {{ $buttonStyle_id == $staff->id ? 'selected' : '' }} value="{{ $staff->id }}">
                                                                                    {{ $staff->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="d-flex align-items-baseline ">
                                                                        ...
                                                                        <select required {{$customerID == "" ? "disabled" : ""}} name=""
                                                                            ...
                                                                            id="">
                                                                            <option value=""></option>
                                                                            @foreach ($shoulderStyles as $staff)
                                                                                <option {{ $shoulderStyle_id == $staff->id ? 'selected' : '' }} value="{{ $staff->id }}">
                                                                                    {{ $staff->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="d-flex align-items-baseline ">
                                                                        ...
                                                                        <select required {{$customerID == "" ? "disabled" : ""}} name=""
                                                                            ...
                                                                            id="">
                                                                            <option value=""></option>
                                                                            @foreach ($sleeveStyles as $staff)
                                                                                <option {{ $sleeveStyle_id == $staff->id ? 'selected' : '' }} value="{{ $staff->id }}">
                                                                                    {{ $staff->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="d-flex align-items-baseline ">
                                                                        ...
                                                                        <select required {{$customerID == "" ? "disabled" : ""}} name=""
                                                                            wire:model='sleeveMouthStyle_id'
                                                                            class="w-100  border border-light"
                                                                            id="">
                                                                            <option value=""></option>
                                                                            @foreach ($sleeveMouthStyles as $staff)
                                                                                <option {{ $sleeveMouthStyle_id == $staff->id ? 'selected' : '' }} value="{{ $staff->id }}">
                                                                                    {{ $staff->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="form-check form-switch"
                                                                        dir="ltr">
                                                                        <input {{$customerID == "" ? "disabled" : ""}} type="checkbox"
                                                                            wire:model='tombanPocket'
                                                                            class="form-check-input"
                                                                            id="customSwitch1">
                                                                        <label class="form-check-label"
                                                                            for="customSwitch1">جیب تنبان</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-3 p-0 ">
                                                                    <textarea {{$customerID == "" ? "disabled" : ""}} name="" wire:model='description' rows="13" class="form-control w-100 rounded-0"
