                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-4">
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <input disabled type="number" step="any" min="1" wire:model='height'
                                            ...
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <input  disabled type="number" step="any" min="1" wire:model='shoulder'
                                                    max="150" class="form-control p-1" id="validationCustom01"
                                                    placeholder="00" required>
                                            </div>
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <input  disabled type="number" step="any" min="1"wire:model='sleeve'
                                                    max="150" class="form-control p-1" id="validationCustom01"
                                                    placeholder="00" required>
                                            </div>
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <input  disabled type="number" step="any" min="1" wire:model='neck'
                                                    max="150" class="form-control p-1" id="validationCustom01"
                                                    placeholder="00" required>
                                            </div>
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <input  disabled type="number" step="any" min="1" wire:model='side'
                                                    max="150" class="form-control p-1" id="validationCustom01"
                                                    placeholder="00" required>
                                            </div>
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <input  disabled type="number" step="any" min="1" wire:model='sideDown'
                                                    max="150" class="form-control p-1" id="validationCustom01"
                                                    placeholder="00" required>
                                            </div>
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <input  disabled type="number" step="any" min="1" wire:model='skirt'
                                                    max="150" class="form-control p-1" id="validationCustom01"
                                                    placeholder="00" required>
                                            </div>
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <input  disabled type="number" step="any" min="1" wire:model='tomban'
                                                    max="150" class="form-control p-1" id="validationCustom01"
                                                    placeholder="00" required>
                                            </div>
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <input  disabled type="number" step="any" min="1" wire:model='leg' max="150"
