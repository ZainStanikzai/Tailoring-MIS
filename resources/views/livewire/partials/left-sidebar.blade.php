    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('page.customer') }}" wire:navigate.hover  class="">
                        <i class="uil-users-alt"></i>
                        <span>مشتریان</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('page.staff') }}" wire:navigate.hover class="">
                        <i class="uil-user-arrows"></i>
                        <span>کارکونکی</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('page.style') }}" wire:navigate.hover class="">
                        <i class="uil-horizontal-distribution-center"></i>
                        <span>ستایلونه</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('page.setting') }}" wire:navigate.hover class="">
