<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <button type="button" onclick="document.body.setAttribute('data-sidebar-size','lg')" class="btn btn-sm px-3 font-size-16 header-item waves-effect vertical-menu-btn">
            ...
            <form class="app-search d-none d-lg-block" >
                <div class="position-relative">
                    <input type="text" class="form-control border text-right" placeholder="لټون ...">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ asset('assets/images/logo-sm.png') }}" alt="Header Avatar">
