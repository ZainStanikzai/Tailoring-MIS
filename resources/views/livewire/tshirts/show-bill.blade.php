                                ...
                                <form id="formBillShow" wire:submit='update'>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <select disabled name="" wire:model='neckStyle_id'
                                                    ...
                                                    @foreach ($neckStyles as $neckStyle)
                                                        <option {{ $neckStyle_id == $neckStyle->id ? 'selected' : '' }}
                                                            value="{{ $neckStyle->id }}">
                                            ...
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <select disabled name="" wire:model='sleeveStyle_id'
                                                    ...
                                                    @foreach ($sleeveStyles as $sleeve)
                                                        <option {{ $sleeveStyle_id == $sleeve->id ? 'selected' : '' }}
                                                            value="{{ $sleeve->id }}">
                                                            {{ $sleeve->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="d-flex align-items-baseline ">
                                                ...
                                                <select disabled name="" wire:model='stripStyle_id'
                                                    ...
                                                    @foreach ($stripStyles as $strip)
                                                        <option {{ $stripStyle_id == $strip->id ? 'selected' : '' }}
                                                            value="{{ $strip->id }}">
                                                            {{ $strip->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-3 p-0 ">
                                            <textarea disabled wire:model='description' name="" rows="9" class="form-control w-100 rounded-0"
